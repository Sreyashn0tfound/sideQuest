...
export default function AuthScreen() {
  ...
  async function handleSendResetCode() {
      if (!email || !email.includes('@')) {
          Alert.alert("Error", "Please enter your account email first.");
          return;
      }
      ...
      try {
          ...
          setCodeSent(true);
          Alert.alert("Code Sent! 📧", "Check your email for the recovery code.");
      } catch (error: any) {
  ...
  async function handleVerifyAndReset() {
      ...
      if (newPassword.length < 6) {
          Alert.alert("Error", "New passcode must be at least 6 characters.");
          return;
      }
      ...
      try {
          ...
          Alert.alert("Success! 🔓", "Your passcode has been reset. You are now logged in.");
